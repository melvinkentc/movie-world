...
<body style=" font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
  <div id="main">
    <nav>
      <div id="navbarcontainer">
        ...
        <ul style="text-align: center;" >
          <li><a href="#home" class="active" target="index.html">HOME</a></li>
    ...
    <p id="current-date" style="font-size: small; font-weight: bold; text-transform: uppercase;"></p>
    <!-- Register Modal -->
    ...
    <!-- Coming Soon -->
    <section>
      <h1 class="shadow-title" style="text-align: center;"title="click poster to buy ticket">COMING SOON</h1>
      <div class="ticket"><p style="text-align: center;">click poster to buy ticket</p></div>
      <div class="slider-container hover-slider">
        <div class="slider-track">
          <a href="#"><img src="images/amateur.gif" alt="1"></a>
          <!-- ... -->
