...
<body>
  ...
  <nav>
    <div id="navbarcontainer">
      ...
      <ul style="text-align: center;">
        ...
        <li><a href="bookingandevents.html" class="active">BOOKING AND EVENTS</a></li>
  ...
  <div id="main">
    ...
    <!-- Booking and Events Section -->
    <section>
      <div class="bookingandevents">
        ...
        <p>For Movieworld sales or booking inquiries, please email us at <span style="color: blue;">movieworld@gmail.com</span> with the following information:</p>
