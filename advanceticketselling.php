...
<body>
    ...
    <nav>
      <div id="navbarcontainer">
        ...
        <ul style="text-align: center;" >
          ...
          <li><a href="advanceticketselling.html" class="active">ADVANCE TICKET SELLING</a></li>
    ...
    <!-- Now Showing -->
   <section>
    <h1 style="text-align: left; font-size: 40px; font-weight: bold;">Advance Ticket Selling</h1>
    <hr class="hr-shadow" />
   </section>
  </div>
